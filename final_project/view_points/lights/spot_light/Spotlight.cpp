...
Spotlight::Spotlight(glm::vec3 lightPosition, float lightIntensity, glm::vec3 lightColor, float viewAzimuth, float viewPolar, float innerConeAngle, float outerConeAngle): Light(lightPosition, lightIntensity, lightColor, viewAzimuth, viewPolar) {
