...
GeometryPass::GeometryPass(const int width, const int height) : RenderPass(
	width, height,
	LoadShadersFromFile("../final_project/shaders/geometry.vert", "../final_project/shaders/geometry.frag")) {
}
